...
class DB_Functions_GCM {
    ...
    public function storeUser($gcm_regid, $instanceId, $userName) {
    echo "$gcm_regid";
        // insert user into database
        $result = mysqli_query($GLOBALS['mysqli_connection'], "INSERT INTO gcm_users(username, gcm_instance_id, gcm_regid, created_at) VALUES('$userName','$instanceId', '$gcm_regid', NOW())");
