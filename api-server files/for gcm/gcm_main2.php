...
if (isset($_POST['userName'])) 
{
    ...
    echo "<br>Error: message got<br>".$pushMessage;


    if ($pushMessage == "" || $pushMessage == null) 
    {
        echo "<br>Error: message can not be empty<br>";
        $error++;
    }
} 
else 
{
    echo "<br>Are you somehow trying to hack me?<br>Forget it buddy...<br>Close your computer and go to sleep...<br>";
    $error++;
}
...
//$query = "SELECT gcm_regid FROM gcm_users WHERE name = $watchername";
...
if (isset($gcmRegIds) && isset($pushMessage)) {
    ...
    echo "Unknown error occured, contact your Push Notification Service Provider".$gcmRegIds;
